...
contains(ANDCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += ANDCOIN_NEED_QT_PLUGINS
...
contains(ANDCOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = andcoin-qt_test
DEFINES += ANDCOIN_QT_TEST
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/andcoin-qt.rc
...
macx:ICON = src/qt/res/icons/andcoin.icns
...
LIBS += -lssl -lcrypto -lgmp -ldb_cxx$$BDB_LIB_SUFFIX
