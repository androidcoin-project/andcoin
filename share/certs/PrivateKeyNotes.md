...
unlocked to sign the AndCOIN-Qt.app bundle.
...
allowing somebody to distribute a AndCOIN-Qt.app or andcoin-qt-setup.exe with a valid
...
that the andcoin-qt.exe file inside the installer had not been tampered with.
