...
uint256 hashGenesisBlock("0x000003cbda67c013744468be2a4ae7144347fc9dc296bf62598a8ce9f38caa70");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AndCOIN: starting difficulty is 1 / 2^12
...
{
    // AndCOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nSubsidyGenesisBlock = 5 * COIN;
static const int64 nSubsidyInitialBlock = 875000 * COIN;
static const int64 nSubsidyRolloffBlock = 0 * COIN;
static const int64 nSubsidyBase = 5 * COIN;
static const int64 nSubsidyBase2ndYear = 0.625 * COIN;

static const int nHeightGenesisBlock = 0;
static const int nHeightInitialBlock = 1;
static const int nHeightHalfoffBlocks = 525600;
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight < nHeightHalfoffBlocks) // 1st year cut half every 3 months
    {
        int64 nSubsidy = nSubsidyBase;
        nSubsidy >>= (nHeight / 131400); // 5, 2.5, 1.25, 0.625
    ...
    // this is every 12 months
        int64 nSubsidy = nSubsidyBase2ndYear;
        nSubsidy >>= (nHeight / 525600); // 0.625, 0.3125, 0.15625, 0.078125, 0.0390625, ...

    return nSubsidy + nFees;
    }
}

static const int64 nTargetTimespan = 60; // AndCOIN: 1 minute
...
{
    // use simple difficulty for first 50 block
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // AndCOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    // was causing -reindex to crash andcoind
    if (hash != hashGenesisBlock) {
...
{
    // AndCOIN: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000beed5e3190153995fc2cb476a6047019aedc9d1f6bdfd0c0487382f2f80");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040328a1e8d95d565c1ca2534e079174147c29d891f6b2b307ac8bdb94d27c58a539be3d1d2681ab965688960d0841c794f777df1c9d7d8811dcdb12f9b1e13cae") << OP_CHECKSIG;
        ...
        block.nVersion = 1;
        block.nTime    = 1519556400; // Sunday, February 25, 2018 6:00:00 PM GMT+07:00
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 225773;

        if (fTestNet)
        {
            block.nTime    = 1518519309;
            block.nNonce   = 63295;
        }
       ...
       if (false && block.GetHash() != hashGenesisBlock)
        ...
        //// debug print
             ...
             assert(block.hashMerkleRoot == uint256("0xd7336df132ac787d5de8379bdb76a86c3b1f2bf79580a49ae76628476655794f"));     
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AndCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AndCOINMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static AndCOINMiner(CWallet *pwallet)
{
    printf("AndCOINMiner started\n");
    ...
    try { loop {
        ...
        printf("Running AndCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AndCOINMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AndCOINMiner, pwallet));
}
