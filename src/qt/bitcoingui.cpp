...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AndCOIN address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AndCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AndCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AndCOIN addresses"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AndCOIN network", "", count));
}
...
{
    QString strTitle = tr("AndCOIN"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid AndCOIN address or malformed URI parameters."),
